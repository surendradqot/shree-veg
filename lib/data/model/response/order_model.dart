...
class OrderModel {
  ...
  OrderModel({
    ...
    _deliveryOutTime = deliveryOutTime;
    _returnedTime = returnedTime;
  ...
  String? get deliveredTime => _deliveredTime;
  String? get failedTime => _failedTime;
  String? get deliveryOutTime => _deliveryOutTime;
  String? get returnedTime => _returnedTime;
  ...
  OrderModel.fromJson(Map<String, dynamic> json) {
    ...
    _placedAt = json['created_at'];
    _updatedAt = json['updated_at'];
    _pendingTime = json['pending_time'];
    _confirmedTime = json['confirmed_time'];
    _processingTime = json['processing_time'];
    _deliveredTime = json['delivered_time'];
    _failedTime = json['failed_time'];
    _deliveryOutTime = json['out_for_delivery_time'];
    _returnedTime = json['returned_time'];
    _cancelledTime = json['canceled_time'];
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['cancel_by'] = _cancelBy;
    data['created_at'] = _placedAt;
    data['updated_at'] = _updatedAt;
    data['pending_time'] = _pendingTime;
    data['confirmed_time'] = _confirmedTime;
    data['processing_time'] = _processingTime;
    data['delivered_time'] = _deliveredTime;
    data['failed_time'] = _failedTime;
    data['out_for_delivery_time'] = _deliveryOutTime;
    data['returned_time'] = _returnedTime;
    data['canceled_time'] = _cancelledTime;
    return data;
  }
}
