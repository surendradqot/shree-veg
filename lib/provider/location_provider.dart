...
class LocationProvider with ChangeNotifier {
  ...
  String _selectedPlace = 'Select City';
  ...
  late LatLng _usersInitialPosition;
  LatLng get usersInitialPosition => _usersInitialPosition;
  ...
  void setSelectedCity(String newData) {
    _selectedCity = newData;

    // Notify listeners about the state change
    notifyListeners();
  }

  void setSelectedPlace(String placeName) {
  ...
  void getCurrentLocation(BuildContext context, bool fromAddress,
    ...
    try {
      ...
      // _usersInitialPosition = LatLng(myPosition.latitude, myPosition.longitude);
      notifyListeners();
    } catch (e) {
      myPosition = Position(
    ...
    print('address received is: $getAddress');

    if (fromAddress) {
      _address = placeMarkToAddress(getAddress);
    } else {
      _pickAddress = getAddress;
    }
    _loading = false;
    notifyListeners();
  }
  ...
  void setLocation(String? placeID, String? address,
    ...
    if (kDebugMode) {
      print('mapController is: $_mapController');
      print('placeId is: $placeID');
      print('address is: $_pickAddress');
      print('position is: $_pickPosition');
    }
