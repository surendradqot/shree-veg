...
class RatingBar extends StatelessWidget {
  ...
  const RatingBar({Key? key, required this.rating, this.size = 18, this.color = const Color(0xFF0B4619)}) : super(key: key);
          ...
          child: Stack(
            ...
            children: [
              ...
              ClipRect(
                ...
                child: Icon(Icons.star, color: color ?? Colors.grey, size: size),
              )
            ],
          ),
        ));
