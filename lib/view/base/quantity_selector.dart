...
class ParticularProductQuantitySelector extends StatelessWidget {
  ...
  const ParticularProductQuantitySelector(
      {Key? key,
                  ...
                  return Container(
                    ...
                    child: Column(
                      ...
                      children: [
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Text(
                                    '${product.name}',
                                    style:
                                        poppinsRegular.copyWith(fontSize: 14),
                                  ),
                                ),
                              ],
                            ),
                        ...
                        SizedBox(
                          height: (80 * product.variations!.length).toDouble(),
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Column(
                                          ...
                                          children: [
                                            Text(
                                              '${product.variations![index].quantity} ${product.unit}',
                                            ...
                                            Row(
                                              children: [
                                                ...
                                                Text(
                                                  '₹${product.variations![index].marketPrice}',
                                                  style:
                                                      poppinsRegular.copyWith(
                                                    fontWeight: FontWeight.w500,
                                                    fontSize: 10,
                                                ...
                                                Container(
                                                  ...
                                                  child: Text(
                                                    '${product.variations![index].discount!.replaceAll("-", "")}% off',
                                                    style:
                                                        poppinsRegular.copyWith(
                                                      color: Colors.white,
                                                      fontSize: 8,
