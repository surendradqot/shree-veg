...
import 'package:shreeveg/view/base/text_hover.dart';
        ...
        return Align(
          ...
          child: ListView.builder(
              ...
              itemBuilder: (context, item) {
                ...
                String? name = '';
                categoryProvider.categoryList![currentIndex0].name!.length > 20
                    ? name =
                        '${categoryProvider.categoryList![currentIndex0].name!.substring(0, 20)} ...'
                    ...
                    onTap: () {
                      Navigator.of(context).pushNamed(
                        RouteHelper.getCategoryProductsRouteNew(
                            categoryModel:
                                categoryProvider.categoryList![currentIndex0]),
