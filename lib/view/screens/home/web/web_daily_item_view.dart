...
class WebDailyItemView extends StatelessWidget {
  ...
  final int index;
  WebDailyItemView(
      {Key? key, required this.productProvider, required this.index})
      : super(key: key);
                      ...
                      children: [
                        ...
                        CustomDirectionality(
                          ...
                          PriceConverter.convertPrice(
                            context,
                            double.parse(productProvider.dailyItemList![index].price!),
                            discount:
                                double.parse(productProvider.dailyItemList![index].discount!),
                            discountType: productProvider
                                .dailyItemList![index].discountType,
                          ),
                          style: poppinsBold.copyWith(
                              fontSize: Dimensions.fontSizeExtraLarge),
                        )),
                        double.parse(productProvider.dailyItemList![index].discount!) > 0
                            ? CustomDirectionality(
                                child: Text(
                                    PriceConverter.convertPrice(
                                      context,
