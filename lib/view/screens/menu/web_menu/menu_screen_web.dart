  ...
  Widget build(BuildContext context) {
    ...
    final List<MenuModel> menuList = [
      MenuModel(
          ...
          route: RouteHelper.myOrder),
      MenuModel(
          icon: Images.profile,
          title: getTranslated('profile', context),
          route: isLoggedIn ? null : RouteHelper.getLoginRoute()),
      MenuModel(
          icon: Images.location,
          title: getTranslated('address', context),
          route: RouteHelper.address),
      MenuModel(
          icon: Images.chat,
          title: getTranslated('live_chat', context),
          route: RouteHelper.getChatRoute(orderModel: null)),
      MenuModel(
          icon: Images.coupon,
          title: getTranslated('coupon', context),
          route: RouteHelper.coupon),
      MenuModel(
          icon: Images.notification,
          title: getTranslated('notification', context),
          route: RouteHelper.notification),
      ...
      MenuModel(
          ...
          route: RouteHelper.getContactRoute()),
      MenuModel(
          icon: Images.privacyPolicy,
          title: getTranslated('privacy_policy', context),
          route: RouteHelper.getPolicyRoute()),
      MenuModel(
      ...
      if (splashProvider.configModel!.returnPolicyStatus!)
        MenuModel(
            ...
            route: RouteHelper.getReturnPolicyRoute()),
      ...
      if (splashProvider.configModel!.cancellationPolicyStatus!)
        MenuModel(
            ...
            route: RouteHelper.getCancellationPolicyRoute()),
      MenuModel(
          icon: Images.aboutUs,
      ...
      MenuModel(
          icon: Images.login,
          title: getTranslated(isLoggedIn ? 'log_out' : 'login', context),
          route: 'auth'),
    ];
                  ...
                  Builder(builder: (context) {
                    return GridView.builder(
                      ...
                      itemBuilder: (context, index) =>
                          MenuItemWeb(menu: menuList[index]),
                    );
                  }),
