...
import 'package:shreeveg/view/screens/home_items_screen/widget/flash_deal_shimmer.dart';
...
class FlashDealsView extends StatelessWidget {
  ...
  const FlashDealsView({Key? key, this.isHomeScreen = true, required String productType}) : super(key: key);
    ...
    return isHomeScreen
        ? Consumer<FlashDealProvider>(
            builder: (context, flashDealProvider, child) {
              ...
              return flashDealProvider.dailyFlashDealList != null &&
                      flashDealProvider.dailyFlashDealList.isNotEmpty
                  ? ListView.builder(
                      padding: const EdgeInsets.all(0),
                      scrollDirection:
                          isHomeScreen ? Axis.horizontal : Axis.vertical,
                      itemCount: flashDealProvider.dailyFlashDealList.isEmpty
                          ? 2
                          : flashDealProvider.dailyFlashDealList.length,
                      itemBuilder: (context, index) {
                        return SizedBox(
                          width: width,
                          child: flashDealProvider.dailyFlashDealList != null
                              ? flashDealProvider.dailyFlashDealList.isNotEmpty
                                  ? Stack(
                                      fit: StackFit.expand,
                                      children: [
                                        CarouselSlider.builder(
                                          ...
                                          itemCount: flashDealProvider
                                                  .dailyFlashDealList.isEmpty
                                              ? 1
                                              : flashDealProvider
                                                  .dailyFlashDealList.length,
                                          itemBuilder: (context, index, _) {
                                            return InkWell(
                                              onTap: () => Navigator.of(context)
                                                  .pushNamed(RouteHelper
                                                      .getProductDetailsRoute(
                                                          product: flashDealProvider
                                                                  .dailyFlashDealList[
                                                              index])),
                                              child: Container(
                                                            ...
                                                            child: ClipRRect(
                                                              ...
                                                              child: FadeInImage
                                                                ...
                                                                image:
                                                                    ...
                                                                    '/${flashDealProvider.dailyFlashDealList[index].image!.isNotEmpty ? flashDealProvider.dailyFlashDealList[index].image?.first : ''}',
                                                                imageErrorBuilder:
                                                                    (c, o, s) =>
                                                                        Image
                                                                            .asset(
                                                            ...
                                                            children: [
                                                              ...
                                                              Row(children: [
                                                                ...
                                                                CustomDirectionality(
                                                                  child: Text(
                                                                    double.parse(flashDealProvider.dailyFlashDealList[index].discount!) >
                                                                            0
                                                                        ? PriceConverter.convertPrice(
                                                                            context,
                                                                            double.parse(flashDealProvider.dailyFlashDealList[index].price!))
                                                                        : '',
                                                                    style: poppinsBold
                                                                        .copyWith(
                                                                      color: Theme.of(
                                                                ...
                                                                CustomDirectionality(
                                                                  child: Text(
                                                                    PriceConverter.convertPrice(
                                                                        context,
                                                                        double.parse(flashDealProvider
                                                                            .dailyFlashDealList[
                                                                                index]
                                                                            .price!),
                                                                        discountType: flashDealProvider
                                                                            .dailyFlashDealList[
                                                                                index]
                                                                            .discountType,
                                                                        discount: double.parse(flashDealProvider
                                                                            .dailyFlashDealList[index]
                                                                            .discount!)),
                                                                    style: poppinsBold
                                                                        .copyWith(
                                                          ...
                                                          child: Container(
                                                            ...
                                                            child: Text(
                                                              PriceConverter
                                                                ...
                                                                context,
                                                                '${flashDealProvider.dailyFlashDealList[index].price}',
                                                                double.parse(flashDealProvider
                                                                    .dailyFlashDealList[
                                                                        index]
                                                                    .discount!),
                              ...
                              : Shimmer(
                                  ...
                                  enabled:
                                      flashDealProvider.dailyFlashDealList == null,
                                  child: Container(
        ...
        : Consumer<FlashDealProvider>(
            builder: (context, flashDealProvider, child) {
              return flashDealProvider.dailyFlashDealList.isNotEmpty
                  ? GridView.builder(
                      gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                          ...
                          crossAxisCount: ResponsiveHelper.isDesktop(context)
                              ...
                              : ResponsiveHelper.isTab(context)
                                  ? 2
                                  : 1),
                      itemCount: flashDealProvider.dailyFlashDealList.length,
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        return ProductWidget(
                          product: flashDealProvider.dailyFlashDealList[index],
                        );
                      },
                    )
                  : GridView.builder(
