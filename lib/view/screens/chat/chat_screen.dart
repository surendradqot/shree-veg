...
import 'package:shreeveg/helper/notification_helper.dart';
...
import 'package:shreeveg/view/screens/chat/widget/message_bubble.dart';
import 'package:shreeveg/view/screens/chat/widget/message_bubble_shimmer.dart';
  ...
  void initState() {
    ...
    FirebaseMessaging.onMessage.listen((RemoteMessage message) {
      ...
      Provider.of<ChatProvider>(context, listen: false)
          .getMessages(1, widget.orderModel, false);
    });
    ...
    if (_isLoggedIn) {
      if (_isFirst) {
        Provider.of<ChatProvider>(context, listen: false)
            .getMessages(1, widget.orderModel, true);
      } else {
        Provider.of<ChatProvider>(context, listen: false)
            .getMessages(1, widget.orderModel, false);
        _isFirst = false;
                        ...
                        child: Container(
                          ...
                          child: ClipRRect(
                            ...
                            child: FadeInImage.assetNetwork(
                              ...
                              imageErrorBuilder: (c, t, o) => Image.asset(
                                isAdmin
                                    ? Images.appLogo
                                    : Images.profilePlaceholder,
                                fit: BoxFit.cover,
                      ...
                      return chatProvider.messageList == null
                          ? Expanded(
                              ...
                              itemBuilder: (context, index) =>
                                  MessageBubbleShimmer(isMe: index.isOdd),
                            ))
                          : Expanded(
                              child: ListView.builder(
                                  reverse: true,
