          ...
          Column(
            ...
            children: [
              ...
              if (data![index].createdAt != null)
                Text(
                  DateConverter.formatDate(data![index].createdAt!),
                  style: poppinsRegular.copyWith(
    ...
    return Column(children: [
      Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
        ...
        if (transaction!.createdAt != null)
          Text(
            '${DateConverter.estimatedDate(transaction!.createdAt!)} ${DateConverter.isoStringToLocalTimeWithAMPMOnly(transaction!.createdAt!.toIso8601String())}',
            style: poppinsRegular.copyWith(
                fontSize: Dimensions.fontSizeSmall,
                color: Theme.of(context).disabledColor),
            maxLines: 1,
