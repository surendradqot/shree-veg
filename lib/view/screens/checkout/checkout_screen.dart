...
import 'package:shreeveg/view/screens/checkout/widget/delivery_fee_dialog.dart';
import 'package:shreeveg/view/screens/checkout/widget/details_view.dart';
import 'package:shreeveg/view/screens/checkout/widget/place_order_button_view.dart';
...
class _CheckoutScreenState extends State<CheckoutScreen> {
  ...
  final List<String> _onlineImages = [
    Images.gpayIcon,
    Images.phonepeIcon,
    Images.paytmIcon,
    Images.amazonIcon,
  ...
  var payTitleStyle = poppinsRegular.copyWith(
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: (ResponsiveHelper.isDesktop(context)
                ...
                : CustomAppBar(
                    title: getTranslated('select_payment_mode', context)))
            as PreferredSizeWidget?,
        body: _isLoggedIn
            ? Consumer<OrderProvider>(
                builder: (context, order, child) {
                  double deliveryCharge = order.distance *
                  ...
                  if ((!kmWiseCharge || order.distance == -1) ||
                      (configModel.freeDeliveryStatus! &&
                          (widget.amount + widget.discount!) >
                              configModel.freeDeliveryOverAmount!)) {
                    deliveryCharge = 0;
                  }
                                            ...
                                            child: Container(
                                              ...
                                              child: Column(
                                                  ...
                                                  children: [
                                                              ...
                                                              Row(
                                                                  ...
                                                                  children: [
                                                                      ...
                                                                      children: [
                                                                        Padding(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            height:
                                                                                30,
                                                                            decoration:
                                                                                BoxDecoration(borderRadius: BorderRadius.circular(5), border: Border.all(width: 1, color: const Color(0xFFD1D1D1))),
                                                                            child:
                                                                                Padding(
                                                                        ...
                                                                        Padding(
                                                                          padding: const EdgeInsets
                                                                              ...
                                                                              left: Dimensions.paddingSizeDefault),
                                                                          child: Text(
                                                                              getTranslated('shree_wallet', context)!,
                                                                              style: payTitleStyle),
                                                                        ),
                                                                        Text(
                                                                    ...
                                                                    Radio(
                                                                        ...
                                                                        groupValue:
                                                                            order
                                                                                .paymentOptionRadioGroupValue,
                                                                        onChanged:
                                                                            (RadioGroup?
                                                                                value) {
                                                                          order.setPaymentOptionRadio(
                                                                              value);
                                                                        })
                                                                  ]),
                                                              const Row(
                                                                  ...
                                                                  children: [
                                                                    Row(
                                                                      children: List.generate(
                                                                          _onlineImages.length,
                                                                          (index) => Padding(
                                                                                padding: const EdgeInsets.only(left: Dimensions.paddingSizeDefault),
                                                                                child: Container(
                                                                                  width: 30,
                                                                                  height: 30,
                                                                                  decoration: BoxDecoration(borderRadius: BorderRadius.circular(5), border: Border.all(width: 1, color: const Color(0xFFD1D1D1))),
                                                                                  child: Padding(
                                                                                    padding: const EdgeInsets.all(Dimensions.paddingSizeExtraExtraSmall),
                                                                                    child: Container(
                                                                                      width: 20,
                                                    ...
                                                    //                   ),
                                                    //                   Text(
                                                    //                       getTranslated('pay_by_any_upi', context)!,
                                                    //                       style: payTitleStyle),
                                                    //                 ],
                                                    //               ),
                                                    //               Radio(
                                                    ...
                                                    //               child: Text(
                                                    //                   'Get flat 30% casshback on orders of ₹399 or \nmore using Cred Pay',
                                                    //                   maxLines:
                                                    //                       2,
                                                    ...
                                                    //                   ),
                                                    //                   Text(
                                                    //                       getTranslated('cards_add', context)!,
                                                    //                       style: payTitleStyle),
                                                    //                 ],
                                                    //               ),
                                                    //               const Padding(
                                                    ...
                                                    //                     child:
                                                    //                         Image.asset(
                                                    //                       Images.paytmWalletIcon,
                                                    //                       width: 36,
                                                    //                       height: 36,
                                                    //                     ),
                                                    //                   ),
                                                    //                   Text(
                                                    //                       getTranslated('paytm_wallet', context)!,
                                                    //                       style: payTitleStyle),
                                                    //                 ],
                                                    //               ),
                                                    //               Radio(
                                                    ...
                                                    //                   ),
                                                    //                   Text(
                                                    //                       getTranslated('amazon_wallet', context)!,
                                                    //                       style: payTitleStyle),
                                                    //                 ],
                                                    //               ),
                                                    //               Radio(
                                                    ...
                                                    //                       .paddingSizeExtraSmall),
                                                    //               child: Text(
                                                    //                   'Get flat 30% casshback on orders of ₹399\nor more using Cred Pay  ',
                                                    //                   maxLines:
                                                    //                       2,
                                                    //                   style: poppinsRegular.copyWith(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              child: Container(
                                                                                ...
                                                                                child: const Icon(Icons.currency_rupee, size: 15),
                                                                              ),
                                                                            ),
                                                                          ),
                                                                        ),
                                                                        Text(
                                                                            getTranslated('cash_pay',
                                                                                context)!,
                                                                            style:
                                                                                payTitleStyle),
                                                                      ],
                                                    ...
                                                    //                       //       1000;
                                                    //                       //   isAvailable =
                                                    //                       //       distance < _branches![order.branchIndex].coverage!;
                                                    //                       // }
                                                    //
                                                    //                       return Padding(
                                                    //                         padding:
                                                    ...
                                                    //                                         color: Theme.of(context).cardColor,
                                                    //                                         border: Border.all(
                                                    //                                           color: index == order.addressIndex ? Theme.of(context).primaryColor : Theme.of(context).hintColor.withOpacity(0.6).withOpacity(0.6),
                                                    ...
                                                    //                                           color: index == order.addressIndex ? Theme.of(context).textTheme.bodyLarge?.color?.withOpacity(0.6) : Theme.of(context).hintColor.withOpacity(0.6).withOpacity(.8),
                                                    //                                         )),
                                                    ...
                                                    //                           fontSize: Dimensions
                                                    //                               .fontSizeLarge,
                                                    //                           color: order.selectDateSlot == index
                                                    //                               ? Colors.white
                                                    //                               : Colors.grey[500]),
                                                    //                     ),
                                                    //                   ),
                                                    ...
                                                    //                           decoration:
                                                    //                               BoxDecoration(
                                                    //                             color: order.selectTimeSlot == index ? Theme.of(context).primaryColor : Colors.white,
