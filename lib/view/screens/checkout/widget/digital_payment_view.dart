...
class DigitalPaymentView extends StatefulWidget {
  ...
  const DigitalPaymentView({Key? key, required this.paymentList})
      : super(key: key);
          ...
          return AutoScrollTag(
            ...
            child:
              ...
              return InkWell(
                ...
                onTap: () async {
                  orderProvider.setPaymentMethod(
                      orderProvider.paymentMethod == method ? '' : method);
                  await scrollController!.scrollToIndex(
                      widget.paymentList.indexOf(method),
                  ...
                  child: Container(
                    ...
                    child: Stack(
                      children: [
                        ...
                        if (orderProvider.paymentMethod == method)
                          Positioned.fill(
                            child: Align(
