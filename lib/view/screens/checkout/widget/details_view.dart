...
import 'package:shreeveg/view/screens/checkout/widget/digital_payment_view.dart';
  ...
  Widget build(BuildContext context) {
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      Padding(
        ...
        child: Text(getTranslated('most_preferred', context)!,
                        ...
                        return CustomDirectionality(
                          child: Text(
                            _freeDelivery
                                ...
                                : (_selfPickup || orderProvider.distance != -1)
                    ...
                    children: [
                      ...
                      CustomDirectionality(
                        ...
                        PriceConverter.convertPrice(context,
                            _amount + (_freeDelivery ? 0 : _deliveryCharge)),
                        style: poppinsMedium.copyWith(
                            fontSize: Dimensions.fontSizeExtraLarge,
                            color: Theme.of(context).primaryColor),
                      )),
