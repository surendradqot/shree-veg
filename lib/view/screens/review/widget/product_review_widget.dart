                                ...
                                children: [
                                  ClipRRect(
                                    ...
                                    child: FadeInImage.assetNetwork(
                                      ...
                                      image:
                                          '${Provider.of<SplashProvider>(context, listen: false).baseUrls!.productImageUrl}/${orderDetailsList[index].image!.isNotEmpty ? orderDetailsList[index].image![0] : ''}',
                                      height: 70,
                                      width: 85,
                                      fit: BoxFit.cover,
                                  ...
                                  Expanded(
                                    ...
                                    children: [
                                      Text(orderDetailsList[index].name!,
                                          style: poppinsMedium,
                                          maxLines: 2,
                              ...
                              SizedBox(
                                ...
                                child: ListView.builder(
                                  ...
                                  itemBuilder: (context, i) {
                                    return InkWell(
                                      child: Icon(
                                        orderProvider.ratingList[index] <
                                                (i + 1)
                                            ? Icons.star_border
                                            : Icons.star,
                                        size: 25,
