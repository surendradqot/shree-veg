...
class VerificationScreen extends StatefulWidget {
  ...
  const VerificationScreen(
      {Key? key, required this.emailAddress, this.fromSignUp = false})
      : super(key: key);
...
class _VerificationScreenState extends State<VerificationScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      //     : CustomAppBar(
      //         title: getTranslated(
      //             isPhone ? 'verify_phone' : 'verify_email', context),
                    ...
                    child: Column(
                      children: [
                        ...
                        Padding(
                          ...
                          child: Center(
                              child: Text(
                            '${getTranslated('enter_verification_code', context)}',
                        ...
                        Padding(
                          ...
                          child: Center(
                              child: Text(
                            'We will send a code to ${widget.emailAddress!.trim()}',
                            textAlign: TextAlign.center,
                        ...
                        Padding(
                          padding: EdgeInsets.symmetric(
                              horizontal: width > 850 ? 300 : 39, vertical: 35),
                        ...
                        Row(
                          ...
                          children: [
                            Text(getTranslated('confirm_within', context)!,
                                style: poppinsMedium.copyWith(
                                    // color: Theme.of(context)
                                    //     .textTheme
                                    //     .bodyLarge!
                                ...
                                : TextButton(
                                    ...
                                    child: Builder(builder: (context) {
                                      ...
                                      return CustomDirectionality(
                                        child: Text(
                                            (authProvider.currentTime != null &&
                                                    authProvider.currentTime! >
                                                        0)
                                                ? '${minutes > 0 ? '${minutes}m :' : '00:'}${seconds}s'
