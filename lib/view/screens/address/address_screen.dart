...
import 'package:shreeveg/view/screens/address/widget/adress_widget.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: ResponsiveHelper.isMobilePhone()
          ? CustomAppBar(title: 'Addresses', backgroundColor: Theme.of(context).primaryColor, buttonTextColor: Colors.white,)
